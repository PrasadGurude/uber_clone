        ...
        <div >
            ...
            <div className=' flex justify-between items-center flex-col'>
                ...
                <div className='w-full mt-5 flex flex-col text-center'>
                    <button onClick={() => {
                        endRide()
                    }} className='bg-green-500 py-2 w-[100%] rounded-lg mt-2 text-center text-lg '>Finish Ride</button>
                    <p className='text-red-400 mt-5 text-sm'>Click on finish ride button if you have completed the payment.</p>
                </div>
            </div>
        </div>
    )
