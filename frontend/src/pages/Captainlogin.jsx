  ...
  return (
    <div className='h-screen flex justify-between flex-col bg-[#eeeeee]'>
        ...
        <div className='  flex flex-col  pt-8 '>
          ...
          <div className=' pb-7 py-3 px-4 '>
            ...
            <input
              ...
              value={password}/>
            <button className='w-full flex justify-center items-center bg-yellow-400 text-white py-3 rounded mt-5 hover:bg-neutral-950 mb-2'>Login</button>
      ...
      <div className='py-3 px-4 pb-5'>
        <Link to={'/login'} className='w-full flex justify-center items-center bg-neutral-900 text-white py-3 rounded mt-5 hover:bg-neutral-950 mb-2' >
